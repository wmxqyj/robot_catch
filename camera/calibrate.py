...
import time
import cv2
from UR_Robot import UR_Robot         # TODO 机械臂接口修改
...
workspace_limits = np.asarray([[0.2, 0.4], [0.4, 0.6], [0.05, 0.1]])      # TODO  待修改，x y z 轴限制

calib_grid_step = 0.05    # 0.05m, 即每次修改变化步长，在上述中即有50个变化点
# checkerboard_offset_from_tool = [0,-0.13,0.02]  # change me!
checkerboard_offset_from_tool = [0,0.121,0]              # TODO
...
np.savetxt('camera_pose.txt', camera_pose, delimiter=' ')    # TODO
print('Done.')
