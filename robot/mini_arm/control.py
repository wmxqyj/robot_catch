...
def sendData(arg):
    ...
    url = f"http://192.168.137.159/command?{arg}&time={milliseconds_timestamp}"
...
#     z = 5
#     while True:
#         x, y, z = map(float, input('请输入坐标x、y、z(以空格分隔）：\n').split())
#         valid, base, shoulder, elbow, wrist = backward_kinematics(x, y, z, alpha=180)    # 逆运动学解算出关节坐标
#         hand = 90
#         if valid:
